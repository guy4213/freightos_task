...
from app.models import SeatType, BookingStatus
...
class FlightOut(BaseModel):
    ...
    arrival_at: datetime
    available_seats: int  # computed in service
...
class SeatOut(BaseModel):
    ...
    seat_type: SeatType
    base_price: Decimal
    status: str         # "available" | "reserved"  (computed in service)
...
class SeatBookingIn(BaseModel):
    """One seat + its passenger, submitted together"""
    seat_id: UUID
